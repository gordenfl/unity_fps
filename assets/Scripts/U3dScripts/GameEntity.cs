...
public class GameEntity : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        Transform uiTransform = gameObject.transform.Find("HeroUI");
        if (uiTransform == null)
        {
            return;
        }
        TextMesh textMesh = uiTransform.GetComponent<TextMesh>();
        if (textMesh == null)
        {
            return;
        }

        textMesh.text = entity_name;
        ...
        //绘制NPC名称
        //GUI.Label(new Rect(uiposition.x - (nameSize.x / 2), uiposition.y - nameSize.y - 5.0f, nameSize.x, nameSize.y), );
    ...
    public void OnJump()
    {
        ...
        jumpState = 1;
        //transform.Find ("Hero").GetComponent<Animator> ().runtimeAnimatorController; 
    }
}
